...
9. [] Backend: Test backend endpoints (npm start, POST /api/jobs/fetch)
...
14. [] Frontend: Update FrontEnd/src/pages/Jobs.jsx (debounce, sort, source filter/badge, infinite toggle, skeletons)
15. [] Frontend: Update FrontEnd/src/pages/JobDetails.jsx (+ source/applyLink)
16. [] Frontend: Enhance UserDashboard.jsx (saved/recent if needed)
17. [] Test full flow: Fetch 1000+ jobs, search/paginate/infinite, scale perf
18. [] Update README.md (+ setup, .env, run commands)
19. [] attempt_completion

**Next Step:** #2 Backend deps
